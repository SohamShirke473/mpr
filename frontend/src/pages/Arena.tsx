        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative z-10 bg-card border border-border rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 flex flex-col items-center gap-5">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <button onClick={() => setShowLeaveDialog(false)} className="w-full px-4 py-2.5 rounded-lg border border-border bg-secondary hover:bg-secondary/70 text-sm font-medium transition-colors">Stay</button>
            </div>
          </div>
        </div>
      )}
