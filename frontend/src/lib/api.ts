...
export interface BattlePlayer {
  ...
  aiBonus: number;
  total: number;
  player1EasyLastSubmissionTime?: string | null;
  player1MediumLastSubmissionTime?: string | null;
  player1HardLastSubmissionTime?: string | null;
  player2EasyLastSubmissionTime?: string | null;
  player2MediumLastSubmissionTime?: string | null;
  player2HardLastSubmissionTime?: string | null;
}
